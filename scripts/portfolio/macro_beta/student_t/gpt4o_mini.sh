#!/usr/bin/env bash
#
# Alpha-beta arm: portfolio run on gpt4o_mini sentiment, student_t target
# distribution, with macro-beta stock filtering.
#   -> benchmark_macro_beta/gpt4o_mini/student_t/
#
# Pairs with the baseline in scripts/portfolio/student_t/gpt4o_mini.sh and the I-MACD
# arm in scripts/portfolio/imacd/student_t/gpt4o_mini.sh. All three train the same
...
#   ./scripts/portfolio/macro_beta/student_t/gpt4o_mini.sh --holdings 40 60
