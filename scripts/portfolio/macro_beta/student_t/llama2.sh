#!/usr/bin/env bash
#
# Alpha-beta arm: portfolio run on llama2 sentiment, student_t target
# distribution, with macro-beta stock filtering.
#   -> benchmark_macro_beta/llama2/student_t/
#
# Pairs with the baseline in scripts/portfolio/student_t/llama2.sh and the I-MACD
# arm in scripts/portfolio/imacd/student_t/llama2.sh. All three train the same
...
#   ./scripts/portfolio/macro_beta/student_t/llama2.sh --holdings 40 60
