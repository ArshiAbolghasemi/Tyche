#!/usr/bin/env bash
#
# Alpha-beta arm: portfolio run on finbert sentiment, student_t target
# distribution, with macro-beta stock filtering.
#   -> benchmark_macro_beta/finbert/student_t/
#
# Pairs with the baseline in scripts/portfolio/student_t/finbert.sh and the I-MACD
# arm in scripts/portfolio/imacd/student_t/finbert.sh. All three train the same
...
#   ./scripts/portfolio/macro_beta/student_t/finbert.sh --holdings 40 60
