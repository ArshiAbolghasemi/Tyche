#!/usr/bin/env bash
#
# Alpha-beta arm: portfolio run on mistral sentiment, student_t target
# distribution, with macro-beta stock filtering.
#   -> benchmark_macro_beta/mistral/student_t/
#
# Pairs with the baseline in scripts/portfolio/student_t/mistral.sh and the I-MACD
# arm in scripts/portfolio/imacd/student_t/mistral.sh. All three train the same
...
#   ./scripts/portfolio/macro_beta/student_t/mistral.sh --holdings 40 60
