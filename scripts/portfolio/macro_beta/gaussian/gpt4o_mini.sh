#!/usr/bin/env bash
#
# Alpha-beta arm: portfolio run on gpt4o_mini sentiment, gaussian target
# distribution, with macro-beta stock filtering.
#   -> benchmark_macro_beta/gpt4o_mini/gaussian/
#
# Pairs with the baseline in scripts/portfolio/gaussian/gpt4o_mini.sh and the I-MACD
# arm in scripts/portfolio/imacd/gaussian/gpt4o_mini.sh. All three train the same
...
#   ./scripts/portfolio/macro_beta/gaussian/gpt4o_mini.sh --holdings 40 60
