#!/usr/bin/env bash
#
# Alpha-beta arm: portfolio run on mistral sentiment, gaussian target
# distribution, with macro-beta stock filtering.
#   -> benchmark_macro_beta/mistral/gaussian/
#
# Pairs with the baseline in scripts/portfolio/gaussian/mistral.sh and the I-MACD
# arm in scripts/portfolio/imacd/gaussian/mistral.sh. All three train the same
...
#   ./scripts/portfolio/macro_beta/gaussian/mistral.sh --holdings 40 60
