#!/usr/bin/env bash
#
# Portfolio run on FinBERT-MiniLM sentiment, Gaussian target distribution.
#   -> benchmark/finbert_minilm/gaussian/
#
# Needs ./scripts/news/finbert_minilm.sh to have run first.
# Extra args override the defaults, e.g.
#   ./scripts/portfolio/gaussian/finbert_minilm.sh --holdings 5 20
